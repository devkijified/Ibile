...
function AdminPanel() {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'products' | 'staff'>('dashboard')

  return (
    <div>
      <div style={{ display: 'flex', gap: '8px', borderBottom: '1px solid #e5e7eb', padding: '0 20px', background: 'white' }}>
        <button
